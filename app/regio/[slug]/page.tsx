...
export default async function AreaPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main id="main-content">
      ...
      <JsonLd data={{ "@context": "https://schema.org", "@type": "Service", name: `Autorijlessen in ${area.name}`, provider: { "@type": "DrivingSchool", name: siteConfig.name }, areaServed: { "@type": "City", name: area.name }, url: `${siteConfig.url}/regio/${slug}`, serviceType: "Autorijles" }} />
    </main>
  );
}
