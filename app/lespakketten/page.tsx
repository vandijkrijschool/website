...
export default function PackagesPage() {
  return (
    <main id="main-content">
      ...
      <section className="section section--compact"><div className="site-shell split-cta"><div><span className="eyebrow">Hulp bij kiezen</span><h2>Bespreek jouw mogelijkheden.</h2><p>Geef tijdens de intake je ervaring, planning en pakketvoorkeur door. Je ontvangt persoonlijk advies.</p></div><div className="button-row"><Link className="button" href="/proefles">Plan intake <ArrowRight width="17" /></Link><Link className="button button--ghost" href="/tarieven">Bekijk alle tarieven</Link></div></div></section>
    </main>
  );
}
