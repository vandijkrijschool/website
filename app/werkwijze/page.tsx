...
import { Calendar, Car, Check, Gauge, RouteIcon, Shield } from "../components/Icons";
...
export default function MethodPage() {
  ...
  return (
    <main id="main-content">
      ...
      <section className="section section--soft" id="digitaal"><div className="site-shell local-intro"><div><SectionHeading eyebrow="Digitale ondersteuning" title="Jouw rijopleiding in PlanGo." /><p>Plan rijlessen, bekijk je persoonlijke leerdoelen en lees na iedere les de feedback van je instructeur terug.</p><ul className="checklist"><li><Check width="17" /> Agenda en lestijden</li><li><Check width="17" /> Persoonlijke leerdoelen</li><li><Check width="17" /> Voortgang per onderdeel</li><li><Check width="17" /> Lesverslagen en feedback</li></ul></div><figure className="local-photo"><ResponsiveImage imageBase="plango-tablet-met-lesauto" alt="Tablet met een lesvoortgangsoverzicht en de Van Dijk-lesauto op de achtergrond" sizes="(max-width: 820px) 100vw, 50vw" /><figcaption><Shield width="22" /><span>PlanGo</span><strong>Alles overzichtelijk</strong><small>Agenda · doelen · voortgang</small></figcaption></figure></div></section>
      ...
      <SplitCta title="Kies het pakket dat bij je past." text="Vergelijk de vijf startpakketten en bespreek je voorkeur tijdens de intake." primaryHref="/lespakketten" primaryLabel="Vergelijk pakketten" />
    </main>
  );
}
