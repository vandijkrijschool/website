...
export default function MethodPage() {
  ...
  return (
    <main id="main-content">
      <PageHero eyebrow="Eén duidelijke route" title="Zo verloopt jouw weg" accent="naar het rijbewijs." intro="Een goede rijopleiding is geen verzameling losse afspraken. Iedere les heeft een doel en bouwt voort op wat je al beheerst."><Breadcrumbs currentPath="/werkwijze" items={[{ label: "Werkwijze" }]} /></PageHero>
