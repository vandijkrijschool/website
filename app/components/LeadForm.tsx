  ...
  if (submitted) {
    return (
      <div className="form-success" role="status">
        ...
        <span className="demo-confirmation">Referentie · DEMO-NXT-2048</span>
  ...
  return (
    <form aria-busy={submitting} className="lead-form" onSubmit={submit} noValidate>
      ...
      <div className="form-grid">
        <label><span>Voor- en achternaam *</span><input name="naam" autoComplete="name" placeholder="Jouw naam" required /></label>
        <label><span>Postcode</span><input name="postcode" autoComplete="postal-code" inputMode="text" placeholder="2583 AB" /></label>
      ...
      <label className="consent"><input type="checkbox" name="toestemming" required /><span>Ik ga ermee akkoord dat Van Dijk Rijschool contact met mij opneemt over deze aanvraag. Bekijk de <Link href="/privacy">privacyverklaring</Link>.</span></label>
