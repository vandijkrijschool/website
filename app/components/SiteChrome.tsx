      ...
      <div className="site-shell site-header__inner">
        ...
        <div className="header-actions">
          ...
          <Link className="button button--small" href="/proefles">
            Gratis intake <ArrowRight width="16" />
          </Link>
        </div>
        <details className="mobile-nav">
          <summary aria-label="Menu openen"><MenuIcon width="23" /></summary>
          <div className="mobile-nav__panel">
            ...
            {[...primaryNavigation, ...footerNavigation].map((item) => (
              <Link href={item.href} key={item.href}>{item.label}<ArrowRight width="17" /></Link>
            ))}
            <Link className="button" href="/proefles">Gratis intake</Link>
          </div>
        </details>
      </div>
    </header>
