...
export default function DenHaagPage() {
  return (
    <main id="main-content">
      ...
      <JsonLd data={{ "@context": "https://schema.org", "@type": "Service", name: "Autorijlessen in Den Haag", provider: { "@type": "DrivingSchool", name: siteConfig.name }, areaServed: { "@type": "City", name: "Den Haag" }, url: `${siteConfig.url}/rijschool-den-haag`, serviceType: "Autorijles" }} />
    </main>
  );
}
