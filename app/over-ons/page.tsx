    ...
    <main id="main-content">
      ...
      <section className="section section--compact">
        <div className="site-shell">
          <DemoNotice
            title="Een compleet instructeurprofiel, zonder onbevestigde echte claims."
            text="Naam, profieltekst en voertuiginformatie hieronder zijn fictieve demo-data. Voor livegang worden identiteit, foto, WRM-bevoegdheid, ervaring en lesauto officieel bevestigd."
          />
