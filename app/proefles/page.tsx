...
export default function TrialLessonPage() {
  return (
    <main id="main-content">
      <PageHero eyebrow="Kennismaken zonder druk" title="Vraag jouw persoonlijke" accent="intake of proefles aan." intro="Bespreek je ervaring, planning en doelen. Zo bepalen we samen een realistisch startpunt voordat je een definitieve pakketkeuze maakt."><Breadcrumbs currentPath="/proefles" items={[{ label: "Proefles / intake" }]} /></PageHero>
