  ...
  return (
    <main id="main-content">
      ...
      <section className="section"><article className="site-shell legal-copy">
        ...
        <h2>4. Versturen via WhatsApp of e-mail</h2><p>Het formulier op deze website zet je aanvraag klaar in WhatsApp of je e-mailapp. De website bewaart de ingevulde gegevens niet in een eigen database. Je gegevens worden pas verzonden nadat je het klaargezette bericht zelf verstuurt. Vanaf dat moment zijn ook de privacyvoorwaarden van de gekozen berichtendienst van toepassing.</p>
