...
export default function LessonsPage() {
  return (
    <main id="main-content">
      ...
      <JsonLd data={{ "@context": "https://schema.org", "@type": "Service", name: "Autorijlessen categorie B", provider: { "@type": "DrivingSchool", name: siteConfig.name }, areaServed: siteConfig.areas, url: `${siteConfig.url}/rijlessen`, serviceType: "Autorijles" }} />
    </main>
  );
}
