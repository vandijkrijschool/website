...
export const demoStudent = {
  name: "Noor",
  package: "Pakket 30 · 30 rijlessen",
  progress: 68,
  completedLessons: 12,
  upcoming: [
    { day: "Dinsdag", time: "14:30", focus: "Invoegen & uitvoegen", status: "Bevestigd" },
    { day: "Vrijdag", time: "16:00", focus: "Zelfstandig navigeren", status: "Bevestigd" },
    { day: "Volgende week", time: "10:30", focus: "Bijzondere verrichtingen", status: "Gepland" },
  ],
  skills: [
